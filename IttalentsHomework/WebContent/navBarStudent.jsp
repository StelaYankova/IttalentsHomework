		...
		success : function(response) {
			for ( var i in response) {
				$('#groups').append(
						...
						"<li><form action = './GetHomeworksOfGroupsServlet' method = 'GET' style='background-color:#2E71AC'><input type = 'hidden' name = 'groupId' value = "+response[i].id+"><button type = 'submit' style ='padding: 0;border: none;background: #2E71AC; color: #9d9d9d'>"
